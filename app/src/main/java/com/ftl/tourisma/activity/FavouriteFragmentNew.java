...
////import android.util.Log;
//
//public class FavouriteFragmentNew extends Fragment implements View.OnClickListener, Updatable, post_sync.ResponseHandler, ViewPagerEx.OnPageChangeListener {
//
...
//
//    private LinearLayout dotLayout_detail_my_favorite3, llEmptyLayout, listView_fees, ll_header5_location, ll_see_all_my_favorite3, ll_my_favourite1, ll_my_favorite3;
//
//    private int pos = 0;
//
...
////            Log.d("System out", (String) ("GetFavorites " + json));
////            new post_sync(this, "GetFavorites").execute(url, json);
//            new post_sync(getActivity(), "GetFavorites", FavouriteFragmentNew.this, true).execute(url, json);
//
//        } else {
...
//        }
////        }
////        Log.d((String) "System out", (String) "favorite create view....");
//    }
//
...
//            new post_sync(getActivity(), "AddFavorite1", FavouriteFragmentNew.this, true).execute(url, json);
//
//        } else {
//            SnackbarManager.show((Snackbar) Snackbar.with(getActivity()).color(Utils.getColor(getActivity(), R.color.mBlue)).text(Constants.showMessage(getActivity(), mPreferences.getString("Lan_Id", ""), "NOINTERNET")));
//        }
...
//            new post_sync(getActivity(), "DeleteFavorite1", FavouriteFragmentNew.this, true).execute(url, json);
//
//        } else {
//            SnackbarManager.show((Snackbar) Snackbar.with(getActivity()).color(Utils.getColor(getActivity(), R.color.mBlue)).text(Constants.showMessage(getActivity(), mPreferences.getString("Lan_Id", ""), "NOINTERNET")));
//        }
...
//            new post_sync(getActivity(), "PlaceDetailsFav", FavouriteFragmentNew.this, true).execute(url, json);
//
//        } else {
