...
import com.ftl.tourisma.adapters.NewSelectLocationFragmentAdapter;
...
public class NewSelectLocationFragment extends Fragment implements post_sync.ResponseHandler {
...
//            String url = "http://35.154.205.155/mytourisma/json.php?action=newCmsPlaces";
            ...
            new PostSync(getActivity(), "newCmsPlaces", NewSelectLocationFragment.this).execute(url, json);
        } else {
    ...
    public void newCitiesResponse(String resultString) {
        ...
        if (resultString.length() > 2) {
            try {
                ...
                location_recycler_view.setAdapter(new NewSelectLocationFragmentAdapter(getActivity(), newCities, image_models));
